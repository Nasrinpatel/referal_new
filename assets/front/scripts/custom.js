...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var pwaScope = "/";
    var pwaLocation = "../assets/front/_service-worker.js";
    ...
    function init_template(){
        ...
        if(localStorage.getItem(pwaName+'-Theme') == "dark-mode"){document.body.classList.add('theme-dark');}
        if(localStorage.getItem(pwaName+'-Theme') == "light-mode"){document.body.classList.add('theme-light');}
        ...
        if(collapseBtn.length){
            collapseBtn.forEach(el => el.addEventListener('click',e =>{
                if(el.querySelectorAll('i').length){
                    el.querySelector('i').classList.toggle('fa-rotate-360')
                };
            }));
        }
