			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<form action="<?= base_url('admin/Customer_referral/store') ?>" id="" method="post" role="form" enctype="multipart/form-data" data-toggle="validator" >
								<input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?=$this->security->get_csrf_hash()?>" />
												...
												<div class="mb-3">
													...
													<select id="selectize-select" name="cus_id">
														...
														if (count($get_cus)) :
															...
															?>
                                                       			<option value="<?=$cus['cus_id']?>"><?= $cus['customer_name']?></option>
																<?php
															endforeach;
														endif; ?>
                                                    </select>
										...
										<div class="col-lg-6">
											<div class="form-group">
												<div class="mb-3">
													...
													<input type="text" class="form-control" name="customer_name" id="customerName" required="" value="<?= set_value('customer_name')?>"/>
									...
									<div class="row">
										<div class="col-lg-6">
											<div class="form-group">
												<div class="mb-3">
													<label for="customerNumber" class="form-label">Customer Contact Number : <span class="text-danger">*</span></label>
													<input type="text" pattern="\d*" class="form-control" name="customer_phone_no" maxlength="10" id="customerNumber" required="" value="<?= set_value('customer_phone_no')?>"/>
										...
										<div class="col-lg-6">
											<div class="form-group">
												<div class="mb-3">
													...
													<input type="email" id="customerEmail" name="customer_email" class="form-control" name="email" required="" value="<?= set_value('customer_email')?>"/>
										...
										<div class="col-lg-6">
											<div class="form-group">
												<div class="mb-3">
													...
													<textarea id="customerAddress" class="form-control" name="customer_address"><?= set_value('customer_address')?></textarea>
