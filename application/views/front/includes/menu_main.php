<div class="sidebar-main-menu show">
                            <div id="two-col-menu" class="h-100" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: 100%; overflow: hidden;"><div class="simplebar-content" style="padding: 0px;">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div class="collapse" id="sidebarEcommerce">
                                                <ul class="nav-second-level">
                                                    ...
                                                    <li>
                                                        <a href="ecommerce-customers.html">Referrals</a>
                                                    </li>
                                                    <li>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div class="collapse" id="sidebarCrm">
                                                <ul class="nav-second-level">
                                                    ...
                                                    <li>
                                                        <a href="crm-customers.html">Referrals</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                ...
                                <div class="twocolumn-menu-item menuitem-active d-block" id="layouts">
                                    <div class="title-box show">
                                        ...
                                        <ul class="nav flex-column">
                                            ...
                                            <li class="nav-item menuitem-active">
                                                <a class="nav-link active" href="layouts-two-column.html">Two Column Menu</a>
                                            </li>
                                            <li class="nav-item">
                            ...
                            </div></div></div></div><div class="simplebar-placeholder" style="width: auto; height: 277px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: hidden;"><div class="simplebar-scrollbar" style="height: 0px; display: none;"></div></div></div>
