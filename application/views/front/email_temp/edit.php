	...
	<div class="content-page">
		<div class="card card-style">
			<div class="content">
				...
				<div class="content">
					<form action="<?= base_url('front/Email_template/update/'.$etEdit->et_id) ?>" id="" method="post" role="form" enctype="multipart/form-data" data-toggle="validator" >
						...
						<div class="input-style has-borders no-icon input-style-always-active">
							...
							<input type="text" class="form-control" name="email_for" id="companyName"  value="<?= set_value('email_for',$etEdit->email_for)?>"/>
							<?=  form_error('email_for');?>
						</div>
								
						<div class="input-style has-borders no-icon input-style-always-active">
							<label for="email" class="color-highlight font-12">Subject</label>
							<input type="text" id="email" name="email_subject" class="form-control" name="email"  value="<?= set_value('email_subject',$etEdit->email_subject)?>"/>
						...
						<div class="input-style has-borders no-icon input-style-always-active">
							...
							<textarea id="editor1" rows="10" name="email"><?= set_value('email',$etEdit->email)?></textarea>
							<?=  form_error('email');?>
						</div>
						<script>
						...
						<input type="submit" class="btn btn-full btn-m gradient-highlight rounded-s font-13 font-600" style="margin-bottom: 20%;" value="Update">	
					</form>
				</div>
			</div> <!-- container -->
		</div> <!-- content -->
