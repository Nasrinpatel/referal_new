		...
		<div>
			<div class="content" id="tab-group-2">
				<div class="tab-controls tabs-small tabs-rounded">
					<a href="<?= base_url('front/Customer/index')?>" data-tab="tab-1" class="gradient-gray">Default</a>
					<a href="<?= base_url('front/Customer/convertCus')?>" data-tab="tab-2" class="gradient-blue">Bought</a>
				</div>
				<div class="clearfix mb-3"></div>
				<table id="ConCustomerDetTable" class="table table-borderless text-center rounded-sm shadow-l responsive mobile-l display nowrap">
					<thead>
